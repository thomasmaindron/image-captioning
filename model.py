...
img_path = r"C:\Users\benny\benny_perso\eseo\i2\S8\projet_synthèse\image-captioning\dataset\ms_coco_2017\test2017\000000000001.jpg"
...
caption = decoder.predict([vector, ])

encoder.summary()
decoder.summary()

#print("vecteur caractéristique: ", vector)
