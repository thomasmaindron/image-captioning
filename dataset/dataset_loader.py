...
files = {
    "train2017.zip": ("http://images.cocodataset.org/zips/train2017.zip", "ms_coco_2017/train2017"),
    "val2017.zip": ("http://images.cocodataset.org/zips/val2017.zip", "ms_coco_2017/val2017"),
    "test2017.zip": ("http://images.cocodataset.org/zips/test2017.zip", "ms_coco_2017/test2017"),
    "annotations_trainval2017.zip": ("http://images.cocodataset.org/annotations/annotations_trainval2017.zip", "ms_coco_2017/annotations")
}
...
for filename, (url, extracted_folder) in files.items():
    ...
    if os.path.exists(zip_path):
        ...
        with zipfile.ZipFile(zip_path, 'r') as zip_ref:
            zip_ref.extractall("ms_coco_2017/")
